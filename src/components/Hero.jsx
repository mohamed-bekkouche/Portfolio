  ...
  return (
    <div className="w-4/5 text-white">
      <h1 className="text-[4.3rem] text-nowrap leading-[3rem] font-bold mb-7 uppercase relative ">
        ...
        {/* <div className="grid grid-cols-8 gap-[12px] absolute bottom-0 left-0 top-0 translate-x-[-40%] -translate-y-[50%] z-0 bg-transparent w-fit h-fit ">
          {Array.from({ length: 64 }, (_, index) => (
            <div
              key={index}
              className="w-[8px] h-[8px] rounded-full bg-[#242424]"
            />
          ))}
        </div> */}
      </h1>
